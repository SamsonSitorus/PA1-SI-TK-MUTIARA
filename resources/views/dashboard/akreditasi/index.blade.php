                ...
                <div class="card flex-fill w-100 p-3">
                    ...
                    <div class="col-lg-offset-2 col-lg-10">
                        @if ($jumlahSiswaCount === 0)
                            <a href="{{ route('akreditasi.create') }}" class="btn btn-primary"><i data-feather="plus-circle"></i>Tambah jumlah_siswa</a>
                        @endif
                        <div>
                            @if (session('success'))
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $('#akreditasiTable').DataTable();  <!-- Inisialisasi DataTables -->
        });
    </script>
@endsection
@endsection
