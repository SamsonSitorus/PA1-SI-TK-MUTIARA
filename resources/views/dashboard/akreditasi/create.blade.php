            ...
            <div class="col-12">
                <div class="card flex-fill w-100 p-3">
                    ...
                    <form action="{{ route('akreditasi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 row">
                            <label for="grade" class="col-sm-2 col-form-label text-end fw-semibold text-secondary"></label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control @error('grade') is-invalid @enderror" id="grade" name="grade" placeholder="Masukkan Grade" value="{{ old('grade') }}" required>
                                @error('grade')
